 ...
 * Original file: /home/camille/projects/InteractivSystem/GesticIolite_git/GesticIolite/src/com/gesticiolite/gestures/IGestureRecognitionService.aidl
 */
package com.gesticiolite.gestures;
public interface IGestureRecognitionService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.gesticiolite.gestures.IGestureRecognitionService
{
private static final java.lang.String DESCRIPTOR = "com.gesticiolite.gestures.IGestureRecognitionService";
...
/**
 * Cast an IBinder object into an com.gesticiolite.gestures.IGestureRecognitionService interface,
 * generating a proxy if needed.
 */
public static com.gesticiolite.gestures.IGestureRecognitionService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.gesticiolite.gestures.IGestureRecognitionService))) {
return ((com.gesticiolite.gestures.IGestureRecognitionService)iin);
}
return new com.gesticiolite.gestures.IGestureRecognitionService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.gesticiolite.gestures.IGestureRecognitionListener _arg0;
_arg0 = com.gesticiolite.gestures.IGestureRecognitionListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.gesticiolite.gestures.IGestureRecognitionService
{
...
@Override public void registerListener(com.gesticiolite.gestures.IGestureRecognitionListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void unregisterListener(com.gesticiolite.gestures.IGestureRecognitionListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void registerListener(com.gesticiolite.gestures.IGestureRecognitionListener listener) throws android.os.RemoteException;
public void unregisterListener(com.gesticiolite.gestures.IGestureRecognitionListener listener) throws android.os.RemoteException;
