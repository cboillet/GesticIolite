 ...
 * Original file: /home/camille/projects/InteractivSystem/GesticIolite_git/GesticIolite/src/com/gesticiolite/gesture/recognition/IGestureRecognitionService.aidl
 */
...
public static abstract class Stub extends android.os.Binder implements com.gesticiolite.gesture.recognition.IGestureRecognitionService
{
private static final java.lang.String DESCRIPTOR = "com.gesticiolite.gesture.recognition.IGestureRecognitionService";
...
/**
 * Cast an IBinder object into an com.gesticiolite.gesture.recognition.IGestureRecognitionService interface,
 * generating a proxy if needed.
 */
public static com.gesticiolite.gesture.recognition.IGestureRecognitionService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.gesticiolite.gesture.recognition.IGestureRecognitionService))) {
return ((com.gesticiolite.gesture.recognition.IGestureRecognitionService)iin);
}
return new com.gesticiolite.gesture.recognition.IGestureRecognitionService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
com.gesticiolite.gesture.recognition.IGestureRecognitionListener _arg0;
_arg0 = com.gesticiolite.gesture.recognition.IGestureRecognitionListener.Stub.asInterface(data.readStrongBinder());
...
private static class Proxy implements com.gesticiolite.gesture.recognition.IGestureRecognitionService
{
...
@Override public void registerListener(com.gesticiolite.gesture.recognition.IGestureRecognitionListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void unregisterListener(com.gesticiolite.gesture.recognition.IGestureRecognitionListener listener) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void registerListener(com.gesticiolite.gesture.recognition.IGestureRecognitionListener listener) throws android.os.RemoteException;
public void unregisterListener(com.gesticiolite.gesture.recognition.IGestureRecognitionListener listener) throws android.os.RemoteException;
